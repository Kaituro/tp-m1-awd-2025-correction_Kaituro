...
public class BandControllerIntegrationTest {
    ...
    public void testFindBandActif() throws Exception {
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type GET vers "/bands/search?active=Y"
        // then: la requête est acceptée (status OK)
    ...
    public void testFindBandInactif() throws Exception {
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type GET vers "/bands/search?active=N"
        // then: la requête est acceptée (status OK)
        // then: la vue "bands" est rendue
    ...
    public void testFindBandParamFaux() throws Exception {
        // given: un objet MockMvc qui simule des échanges MVC
        // when: on simule une requête HTTP de type GET vers "/bands/search?active=W"
        // then: la requête est acceptée (status OK)
        // then: la vue "bands" est rendue
